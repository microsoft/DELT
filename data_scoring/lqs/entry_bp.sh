...
bash $BASE_PATH/data_scorer/lqs/scripts/tools/prepare_full_dataset.sh $BASE_PATH $DATA_PATH $CONFIG_PATH # tokenize cc use fairseq 125M
...
bash $BASE_PATH/data_scorer/lqs/scripts/tools/prepare_target_dataset.sh $BASE_PATH $CONFIG_PATH # tokenize lima


# Step 3: prepare (sampling and annotation) training dataset for scoring model.
# Step 3.1: proxy data sampling.
bash $BASE_PATH/data_scorer/lqs/scripts/tools/sample_proxy_data.sh $BASE_PATH $CONFIG_PATH # sample proxy data from cc
...
bash $BASE_PATH/data_scorer/lqs/scripts/train_data_scorer.sh $BASE_PATH $CONFIG_PATH # data scorer training
...
bash $BASE_PATH/data_scorer/lqs/scripts/infer_data_scorer.sh $BASE_PATH $SCORER_PATH # data scorer infer (data scoring) 
