...
python3 data_scorer/lqs/tools/prepare_data_scorer_train_data.py \
    --base-path $BASE_PATH \
    --type data_processing \
    --data-dir $BASE_PATH/processed_data/proxy/cc-mistral-1025/163840 \
    --model-type mistral \
    --model-path $BASE_PATH/checkpoints/mistral/160M \
    --proxy-score-path $BASE_PATH/results/proxy_data/cc-lima/160M/sgd-t100-bs8-lr0.008constant1e-07-G2-N16-NN2ct10 \
