...
# data
DATA_DIR="${BASE_PATH}/processed_data/data_scorer_train/cc-sgd100-160M-lima-lqs-163840"
...
CMD="deepspeed ${DISTRIBUTED_ARGS} ${BASE_PATH}/data_scorer/lqs/train_scorer.py ${OPTS} $@"
